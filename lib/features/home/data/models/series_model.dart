...
class SeriesModel extends SeriesEntity {
  ...
  SeriesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    data = json['data'] != null ? new DataSeries.fromJson(json['data']) : null;
  }
...
class DataSeries {
  ...
  DataSeries.fromJson(Map<String, dynamic> json) {
    ...
    if (json['items'] != null) {
      items = <DataSeriesItems>[];
      json['items'].forEach((v) {
        items!.add(new DataSeriesItems.fromJson(v));
      });
    }
    params =
...
class DataSeriesItems {
  ...
  DataSeriesItems.fromJson(Map<String, dynamic> json) {
